...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel panel = createHeader("coding");
		// 4. Add the header component to the quizPanel
		quizPanel.add(panel);
		// 5. Add the quizPanel to the frame
		frame.add(quizPanel);
		// 6. Use the createButton method to set the value of firstButton
		firstButton = createButton("three million");
		...
		// method
		secondButton = createButton("three billion");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (firstButton == buttonPressed) {
			askQuestion("How do you turn on a windows laptop?", "Hit the start button.", 170000000);
		}
		...
		if (secondButton == buttonPressed) {
			askQuestion("what is the last button you hit when you code?", "the save one", 990000000);
		}
